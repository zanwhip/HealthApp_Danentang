  ...
  const SignUpScreen = () => {
    ...
    return (
      <View>
        ...
        <View style={{marginHorizontal : 40, marginTop : 20, width : '80%', alignContent : 'çenter',   }}>
            <Text style= {{ fontSize : 18, fontWeight : '700', }}>Let’s get started! Create your account.</Text>
        </View>
        <View style= {{ marginTop : 25 }}>
          ...
          />
          <Text style= {{ marginLeft : 29, color : '#ADADAD', top : -10 }}>10 characters minimum</Text>
