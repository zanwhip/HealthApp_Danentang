  ...
  const insertToDb = async () => {
    try {
      const { error } = await supabase.from('ExProcess').insert({
        ...
        IdUser: sessionId[sessionId.length - 1].uid,
      });
      console.log(error);
      if (error == null) {
        navigation.navigate(
  ...
  return (
    <View>
      ...
      <View style={styles.Infor}>
        ...
        <View
          style={{ width: '100%', height: 2, backgroundColor: '#D0D0D0' }}
        ></View>
        <View
          style={{
            flexDirection: 'row',
        ...
        >
          ...
          >
            <Text style={{ color: COLORS.primary }}>
              {exercise.CaloriesExercise} Kcal
            </Text>
          </View>
        </View>
        {/* HIGHLIGHT */}
        ...
        >
          ...
          >
            <View>
              ...
              >
                <Text
                  style={{ color: '#5BB6AF', fontSize: 35, fontWeight: '700' }}
                >
                  40%
                </Text>
                <Text style={{ fontSize: 15, color: '#545454' }}>
              ...
              >
                <Text
                  style={{ color: '#F2B455', fontSize: 35, fontWeight: '700' }}
                >
                  40%
                </Text>
                <Text style={{ fontSize: 15, color: '#545454' }}>
                  of daily intensity goal
                </Text>
              </View>
            </View>
          ...
          >
            ...
            <Image
              source={require('../assets/icon/run_yellow.png')}
